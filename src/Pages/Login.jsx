      ...
      <div className='w-11/12 min-h-screen flex flex-row max-lg:flex-col-reverse mx-auto justify-center items-center'>
        <div className='w-1/2 flex flex-col justify-center '>
          <div className='w-[400px]'>
            ...
            <p className='my-5'>Build skills for today, tomorrow, and beyond. <span className='text-caribbeangreen-200 italic'>Education to future-proof your career.</span></p>
          </div>
       <form onSubmit={(event) => submitHandler(event)} className='w-[400px]'>
        ...
        <label className='w-full flex flex-col items-start relative mt-1'>
          ...
          name="email"
          className='bg-richblack-800 rounded-[0.5rem] text-gray-50 p-[12px] w-full h-10 border-b border-b-richblack-200'></input>
        </label>
        ...
        <button className='mb-[25px] bg-yellow-100 w-full text-black p-[3px] rounded-md text-lg'>Login</button>
        </div>
      </form>
      </div>
